...
describe('Vivify scrum tests', () => {
    ...
    it('Valid login', () => {
        cy.intercept('POST', 'https://cypress-api.vivifyscrum-stage.com/api/v2/login').as('token')
        cy.visit('')
        login.login()
    ...
    it('Edit Board', () => {
        ...
        editBoard.popUpMessage.should('contain', 'Successfully updated the Board Basic Info.')
